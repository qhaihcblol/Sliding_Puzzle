...
class QQmlEngine(PySide6.QtQml.QJSEngine):
    ...
    @typing.overload
    def singletonInstance(self, uri: str, typeName: str, /) -> typing.Union[PySide6.QtCore.QObject, PySide6.QtQml.QJSValue, None]: ...
    @typing.overload
    def singletonInstance(self, qmlTypeId: int, /) -> typing.Union[PySide6.QtCore.QObject, PySide6.QtQml.QJSValue, None]: ...
...
class QQmlProperty(Shiboken.Object):
    ...
    def propertyTypeName(self, /) -> typing.Union[bytes, bytearray, memoryview]: ...
